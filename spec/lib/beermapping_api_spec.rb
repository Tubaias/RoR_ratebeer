...
describe "BeermappingApi" do
  describe "in case of cache miss" do
    ...
    it "When HTTP GET returns multiple entries, they are parsed and returned" do
      ...
      expect(second.street).to eq("Tuotekuja 1")
    end
    ...
    it "When HTTP GET returns no entries, an empty array is returned" do
      ...
      stub_request(:get, /.*asdasd/).to_return(body: canned_answer, headers: { 'Content-Type' => "text/xml" })

      places = BeermappingApi.places_in("asdasd")
  ...
  describe "in case of cache hit" do
    ...
    it "When HTTP GET returns no entries, an empty array is returned" do
      ...
      BeermappingApi.places_in("asdasd")
      places = BeermappingApi.places_in("asdasd")
